...
export async function ensureWorkspaceDatabase() {
  ...
  await db.batch([
    ...
    db.prepare(
      "CREATE TABLE IF NOT EXISTS suppliers (id INTEGER PRIMARY KEY, business_id INTEGER NOT NULL, name TEXT NOT NULL, service_type TEXT NOT NULL DEFAULT 'Other', contact_name TEXT NOT NULL DEFAULT '', email TEXT NOT NULL DEFAULT '', phone TEXT NOT NULL DEFAULT '', notes TEXT NOT NULL DEFAULT '', active INTEGER NOT NULL DEFAULT 1, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)",
    ),
    db.prepare(
      "CREATE TABLE IF NOT EXISTS event_expenses (id INTEGER PRIMARY KEY, business_id INTEGER NOT NULL, event_id INTEGER NOT NULL, supplier_id INTEGER, category TEXT NOT NULL DEFAULT 'Other', description TEXT NOT NULL, amount INTEGER NOT NULL, currency TEXT NOT NULL DEFAULT 'MZN', payment_status TEXT NOT NULL DEFAULT 'Planned', incurred_date TEXT NOT NULL DEFAULT '', notes TEXT NOT NULL DEFAULT '', created_by_user_id INTEGER NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)",
    ),
    db.prepare(
      "CREATE TABLE IF NOT EXISTS event_documents (id TEXT PRIMARY KEY, business_id INTEGER NOT NULL, event_id INTEGER NOT NULL, name TEXT NOT NULL, object_key TEXT NOT NULL UNIQUE, content_type TEXT NOT NULL, size INTEGER NOT NULL, category TEXT NOT NULL DEFAULT 'Other', notes TEXT NOT NULL DEFAULT '', uploaded_by_user_id INTEGER NOT NULL, created_at TEXT NOT NULL)",
    ),
    db.prepare(
  ...
  await db.batch([
    ...
    db.prepare(
      "CREATE INDEX IF NOT EXISTS event_expenses_business_event_status_idx ON event_expenses (business_id, event_id, payment_status)",
    ),
    db.prepare(
      "CREATE INDEX IF NOT EXISTS event_expenses_supplier_idx ON event_expenses (business_id, supplier_id)",
    ),
    db.prepare(
      "CREATE INDEX IF NOT EXISTS event_documents_business_event_idx ON event_documents (business_id, event_id)",
    ),
    db.prepare(
